...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "BlogiFy — IT, Security & Tech by Jalal Nasser" },
      { property: "og:description", content: "Hands-on tutorials and analysis on Linux, cybersecurity, WordPress, virtual servers, crypto, and digital marketing." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "BlogiFy — IT, Security & Tech by Jalal Nasser" },
      { name: "twitter:description", content: "Hands-on tutorials and analysis on Linux, cybersecurity, WordPress, virtual servers, crypto, and digital marketing." },
    ...
    scripts: [
      {
        src: "https://www.googletagmanager.com/gtag/js?id=G-4HQ2LPF7ZQ",
        async: true,
      },
      {

        ...
        <div className="hidden lg:flex flex-col gap-6 p-10">
          ...
          <div className="grid grid-cols-2 gap-3">
            {stats.map(({ Icon, label }, i) => (
              <div
                key={label}
                className="group relative bg-[#13141f] border border-[#1e2030] rounded-xl p-4 flex flex-col gap-2 transition-all duration-300 hover:-translate-y-1 hover:border-[#00d4ff]/40 hover:shadow-[0_0_20px_-4px_rgba(0,212,255,0.25)] overflow-hidden"
              >
                ...
                <Icon className="size-4 text-[#8b949e] group-hover:text-[#00d4ff] transition-colors duration-300" />
                <div className="text-xs uppercase tracking-widest text-[#8b949e] group-hover:text-[#e6edf3] transition-colors duration-300">
                  {label}
                </div>
                <div className="h-0.5 w-full bg-[#1e2030] rounded-full overflow-hidden">
                  <div
                    className="h-0.5 bg-[#00d4ff] rounded-full relative overflow-hidden"
                    style={{ width: `${55 + i * 10}%` }}
                  >
